...
from pyalgotrade import tickstratanalyzer
...
class ReturnsAnalyzerBase(tickstratanalyzer.StrategyAnalyzer):
    def __init__(self):
...
class Returns(tickstratanalyzer.StrategyAnalyzer):
    """
    A :class:`pyalgotrade.tickstratanalyzer.StrategyAnalyzer` that calculates time-weighted returns for the
    whole portfolio.
